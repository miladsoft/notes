...
import { NIP10Result } from 'nostr-tools/lib/types/nip10';
...
export class CreateEventComponent implements AfterViewInit {
    ...
    async sendEvent() {
        ...
        const unsignedEvent = this.nostrService.getUnsignedEvent(1, [], finalContent);
    ...
    async sendReply() {
        ...
        const unsignedEvent = this.nostrService.getUnsignedEvent(1, tags, finalContent);
        let signedEvent: Event;
